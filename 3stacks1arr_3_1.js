//obtained from: https://codepen.io/emmawedekind/pen/vMvQow?editors=1012
...
console.log(stack.indexOfTop(0)); //-1
console.log(stack.values); //[]
stack.push(0, 4); // "Item 4 has been successfully added to stack 0"
console.log(stack.indexOfTop(0)); //0
console.log(stack.values); //[ 4 ]
stack.push(0, 3); // "Item 3 has been successfully added to stack 0"
console.log(stack.indexOfTop(0)); //1 
console.log(stack.values); //[ 4 , 3 ]
stack.push(0, 2); // "Item 2 has been successfully added to stack 0"
console.log(stack.indexOfTop(0)); //2
console.log(stack.values); //[ 4, 3, 2 ]
stack.push(0, 1); // "Item 1 has been successfully added to stack 0"
console.log(stack.indexOfTop(0)); //3
